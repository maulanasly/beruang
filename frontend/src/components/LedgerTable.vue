...
const COLUMN_I18N_KEYS = {
  ...
  dividend_yield: 'column.dividendYield',
  estimated_dividend: 'column.estimatedDividend',
...
const COLUMN_HINT_KEYS = {
  ...
  dividend_yield: 'glossary.dividendYield',
  estimated_dividend: 'glossary.dividendYield',
