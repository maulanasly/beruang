export default {
  ...
  howto: {
    ...
    rentbuy1: 'Enter the house price, down payment, mortgage rate (0.07 = 7%), tenor in years, monthly rent, and other monthly buying costs.',
  ...
  rentbuy: {
    ...
    mortgageRate: 'Mortgage rate / year (0.07 = 7%)',
    ...
    appreciation: 'Home appreciation / year (0.04 = 4%)',
    rentGrowth: 'Rent growth / year (0.03 = 3%)',
    otherGrowth: 'Other-cost growth / year (0.03 = 3%)',
    investReturn: 'Invest return / year (0.08 = 8%)',
    closingCosts: 'Closing costs (one-time)',
    sellingRate: 'Selling cost (fraction of value, 0.05 = 5%)',
